const projects = [
    ...
    },
    {
        ...
        about: 'Be The Hero me deu uma grande visão da stack que está sendo usada pelas maioria das empresas, após concluir a semana eu fiquei bem mais empolgado e confiante para realizar um projeto totalmente novo usando tudo que aprendi nessa semana que foi o FIFACMO. O Be The Hero é um projeto feito pelo pessoal da Rocket Seat que possui canal no Youtube com diversos conteúdos contemporêneos sobre desenvovimento web a também mobile',
    ...
    },
    {
        ...
        about: 'Foi minha primeira experiência criando um Back-end completo após a semana Oministack, realizando desde a modelagem de dados até a resposta em Json, para fazer a queries do banco utilizei o sequelize, poderia ter utilizado ele com o Knex mas achei melhor usar apenas o Sequelize para ter uma imersão maior com a tecnologia, já a parte do React Native foi tão turbulenta quando fazer o Back-end pois fiquei um pouco perdido com o template que eles geram automaticamente muito por conta do React Navigation mas assim que entrei na documentação deles tudo ficou bem mais claro, tive dificuldades em coisas bem simples como mudar cor de alguns elementos do navigation como o botomNavigator, como funcionava a parte de styles usando o Javascript, e como citei antes a parte de navegação. Acabei me adapdanto e minha dificuldade ficou mesmo só no Back-end. Esse projeto me custou mais ou menos 6 meses para ser feito, acredito que se eu tivesse fazendo ele hoje provavelmente levaria pelo um pouco menos da metade desse tempo... com certeza foi o projeto mais complexo que já fiz até o momento.',

        description: 'Esse projeto nasceu com a necessidade de suprir algo que seria legal se tivesse nas franquias do FIFA que é um Modo Carreira Online, para você que não conhece, existe apenas offline e basicamente é um modo onde você é o treinador de um time e pode fazer negociações por jogadores de outros times e claro jogar, então resolvi ao menos tentar desenvolver um app que tivesse uma versão online desse modo. No começo não havia nenhuma perpectiva para fazer isso mas eu resolvi começar e foi dando certo conforme o caminhar. Mas falando sobre as funcionalidades do projeto ele possui um login e também um cadastre-se, a parte do cadastro você pode colocar uma imagem sua de perfil, nome e senha. Logo após o cadastro da pessoa existe a possibilidade de colocar a imagem do seu time e claro o nome do seu time. Com o cadastro realizado você pode finalmente acessar a aplicação e desfrutar com seus iniciais 100 milhões para fazer a contratação de jogadores, então com isso, você tem a opção de mercado e por lá existe diversos jogadores aproximadamente 17 mil opções para ser contratados, você pode adicionar determinado jogador aos favoritos e também ao seu carrinho, quando ele é adionado no carrinho, ao topo da aplicação é possível ver o valor total do carrinho mas existe regras nessa parte do carrinho como por exemplo na primeira compra é necessário que tenha pelo menos 25 jogadores para criar o elenco, após a primeira compra que é possível comprar jogadores em varejo. Depois da compra você pode ver na home o valor do seu time que antes era 0 agora já possui algum valor, e ainda na home é possível também ver a quantidade de copas e de ligas que você conquistou(esse recurso deve possuir um administrador para realizar), quando possuir jogadores no seu elenco você pode visitar a opção "elenco" que vai te mostrar os jogadores que você contratou além dos atributos dele, ao tocar na imagem do jogador(funciona no mercado também) você é direcionado para uma nova tela que mostra absolutamente tudo sobre esse jogador desde informações pessoais como nome, idade, altura, peso, nacionalidade também mostra o nível dos atributos como passe, chute, defesa, dividida, chute com efeito, resistência, fôlego e muitíssimo mais, por último nessa tela mostra o overall desse jogador em todas as partes do campo por exemplo se você tem o Messi a posição de origem é ponta direita o overal dele é 94, qual seria o overall do Messi jogando de meio campo? ele vai te mostrar não só no meio campo como em todas as outras posições. Voltanto com a parte do elenco você tem a tela de prancheta que vai te possibilitar mover todos os jogadores do seu elenco de forma livre dentro da prancheta afim de organizar alguma formação ou tática. Agora a parte de negociação com outros clubes funciona da seguinte forma, você vai no perfil do time e vai escolher o jogador que você quer fazer proposta com isso vai abrir um formulário com: o campo do valor da proposta e mensagem, esse formulário também mostra o valor de mercado desse jogador. Quando você envia a proposta com o valor que foi colocado no campo ele será alocado para fazer a contratação, ou seja, ele é removido de sua verba temporariamente até que a resposta do outro clube seja dada se vai aceitar ou não, o time que recebeu a proposta tem até 12 horas para responder, se não respoder a proposta é desfeita e o valor da proposta é realocado a verba (vale lembrar que há uma tela que é possivel ver todas as mensagens dos outros clubes formalizando as propostas ou então recebendo mensagem que o clube recusou a proposta). Infelizmente esse sistema não está no ar por dois motivos, primeiro que o banco é extremamente pesado sem ao mesmo ter um usuário, muito por conta dos 17 mil jogadores com a quantidade de informações e a outra é que o projeto seria um banco de dados para cada turma então fica realmente inviável no momento mas pra mim é um projeto que tenho bastante carinho muito por gostar de futebol mas também por expandir as possibilidades de crescimento pessoal nessa área de desenvolvimento.',
        demo: false,
...

    {
        ...
        about: 'Esse projeto foi feito pelo canal Clever Programmer em live, então só foi uma cópia... particularmente eu não sou muito fã dessa prática de copiar outros projetos seguindo um passo a passo, mas devo reconhecer que ao início da minha carreira isso pode ser importante para ficar cada vez mais ligado no que há de novo no mercado e também para adquirir boas práticas e descobrir cada vez mais novos métodos e formas diferentes de fazer algo determinado.',
